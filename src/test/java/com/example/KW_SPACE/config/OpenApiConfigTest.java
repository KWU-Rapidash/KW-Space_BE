...
class OpenApiConfigTest {
	...
	void openApiDocsArePublicAndExposeServiceInfo() throws Exception {
		mockMvc.perform(get("/v3/api-docs"))
			...
			.andExpect(jsonPath("$.paths['/api/v1/auth/signup'].post.responses['201'].content['application/json'].schema.properties.success")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/signup'].post.responses['201'].content['application/json'].schema.properties.message")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/signup'].post.responses['201'].content['application/json'].schema.properties.username")
				.doesNotExist())
			.andExpect(jsonPath("$.paths['/api/v1/auth/signup'].post.responses['201'].content['application/json'].schema.properties.klasId")
				.doesNotExist())
