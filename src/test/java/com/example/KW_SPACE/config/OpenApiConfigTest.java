...
class OpenApiConfigTest {
	...
	void openApiDocsArePublicAndExposeServiceInfo() throws Exception {
		mockMvc.perform(get("/v3/api-docs"))
			...
			.andExpect(jsonPath("$.paths['/api/v1/auth/logout'].post.requestBody").doesNotExist())
			...
			.andExpect(jsonPath("$.paths['/api/v1/auth/signup'].post.requestBody.content['application/json'].schema.properties.name")
				.exists())
			...
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.summary").value("KLAS 계정 검증"))
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.security").doesNotExist())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.requestBody.content['application/json'].schema.properties.klasId")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.requestBody.content['application/json'].schema.properties.klasPassword")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.responses['200'].content['application/json'].schema.properties.klasId")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.responses['200'].content['application/json'].schema.properties.name")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.responses['200'].content['application/json'].schema.properties.message")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.responses['401']").exists())
			.andExpect(jsonPath("$.paths['/api/v1/auth/klas/verify'].post.responses['503']").exists())
			...
			.andExpect(jsonPath("$.paths['/api/v1/classrooms'].get.responses['200'].content['application/json'].schema.items.properties.times")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/classrooms/{classroomId}/times']").doesNotExist())
			...
			.andExpect(jsonPath("$.paths['/api/v1/user/reservations'].get.parameters[0].schema.enum[1]").value("CANCELED"))
			...
			.andExpect(jsonPath("$.paths['/api/v1/user'].get.responses['200'].content['application/json'].schema.properties.name")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/user'].get.responses['200'].content['application/json'].schema.properties.username")
				.doesNotExist())
			.andExpect(jsonPath("$.paths['/api/v1/user'].get.responses['200'].content['application/json'].schema.properties.klasId")
				.exists())
			.andExpect(jsonPath("$.paths['/api/v1/user'].get.responses['200'].content['application/json'].schema.properties.phoneNumber")
				.exists())
