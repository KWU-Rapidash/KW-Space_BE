...
class JwtAuthenticationFilterTest {
	...
	@Test
	void skipsSwaggerApiDocsEndpointEvenWhenAccessTokenCookieExists() throws Exception {
	...
	@Test
	void skipsSwaggerUiEndpointEvenWhenAccessTokenCookieExists() throws Exception {
